...
String QueryString = "SELECT * from gst.employee_details";
rs = statement.executeQuery(QueryString);
%><div class="tablee" >
<TABLE class="mytab" id="tables">
			 <thead>
			<tr class="header">
			    <th style="width: 20%" >Travel Code</th>
...
Employee_id :<input class="tes" type="text" name= code id="para" /><br><br>
Employee_name:<input class="tes" type="text" name=name id="para1" /><br><br>
Rate:<input type="text" name=rate class="tes" id="para2" /><br><br>
Tax:<input type="text" name=gst id="para3" class="tes"/><br><br>
Distance:<input type="text" name=quantity  class="tes"/><br><br>
